...
The GitHub site ([https://github.com/berkeley-scf/r-bootcamp-fall-2020](https://github.com/berkeley-scf/r-bootcamp-fall-2020)) is the main site for the bootcamp. It has information on logistics, software installation, and is the master repository for materials for the modules.

We'll use:

 - this [Piazza site](piazza.com/berkeley/fall2020/rbootcampfall2020) for discussion and answering questions during (and before) the bootcamp. 
 - the [D-Lab virtual frontdesk](dlab.berkeley.edu/frontdesk) for "in-person" questions during the bootcamp.

I'll make announcements (e.g., about when a break will end and we'll resume the live session) via Piazza.
...
Assistants will be available to help answer any questions you have in several ways:

- On the Piazza site.
- At the Zoom frontdesk (we may use breakout rooms to pair you with an assistant).
- The presenter may be alerted by the counselors that it would be worth answering a question for everyone at once.
- If you notice me making a mistake or have a quick clarification question, feel free to unmute yourself and just ask directly.

If you know the answer to a question posed on the Piazza site, please do help us out by answering it yourself or adding your thoughts. 

Your counseloRs are: Andrew Do, Corrine Elliott, Gift Kiti, Maura Liévano, Avery Richards, Koen Van den Berge
...
- `git clone https://github.com/berkeley-scf/r-bootcamp-fall-2020`

Then to update from the repository to get any changes we've made:

- `cd /directory/where/you/put/the/repository/r-bootcamp-fall-2020`
- `git pull`

## As a zip file

If you don't want to bother using Git or have problems, simply download a zip file with all the material from [https://github.com/berkeley-scf/r-bootcamp-fall-2020/archive/master.zip](https://github.com/berkeley-scf/r-bootcamp-fall-2020/archive/master.zip).
...
During a break on Thursday, we'll ask everyone to fill out a feedback form, but if you leave early, please also fill it out: [https://berkeley.qualtrics.com/jfe/form/SV_afxFnDutFrq5yLP](https://berkeley.qualtrics.com/jfe/form/SV_afxFnDutFrq5yLP)

If you participate in the second track on Tuesday/Thursday, please also fill out this survey: [https://berkeley.qualtrics.com/jfe/form/SV_aVJO1X1zcAHR37L](https://berkeley.qualtrics.com/jfe/form/SV_aVJO1X1zcAHR37L)
