...
We'll use the r-bootcamp-fall-2020@lists.berkeley.edu [Google group](https://groups.google.com/a/lists.berkeley.edu/d/forum/r-bootcamp-fall-2020) for discussion and answering questions during (and before) the bootcamp. 
...
Counselors will be available to help answer any questions you have (just wave to one of them), or feel free to just ask the presenter during the presentation. The counselors will also be monitoring the [Google group Q&A area](https://groups.google.com/a/lists.berkeley.edu/d/forum/r-bootcamp-fall-2020), so feel free to type in a question there (or send email to r-bootcamp-fall-2020@lists.berkeley.edu) and one of the counselors will answer the question. Or if you know the answer, help us out by answering it yourself or adding your thoughts. 

Your counseloRs are: Nima Hejazi (Biostatistics), Miyabi Ishihara (Statistics), Dana Seidel (ESPM alum), and Evan Muzzall (D-Lab).
...
* To Evan, Nima, Dana, and Miyabi.
* To D-Lab for sponsorship and logistical support.
* To the Statewide Database at Berkeley Law for hosting/co-sponsoring.
