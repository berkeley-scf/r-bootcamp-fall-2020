% R bootcamp, Module 8: Workflows, managing projects and good practices
...
**POLL 8A**: Have you used R's debugger?
...
**POLL 8B**: Suppose you have a CSV file with one million rows and one thousand columns, filled with numbers. How much memory will this take up if you read the data into R?
...
[https://berkeley.qualtrics.com/jfe/form/SV_afxFnDutFrq5yLP](https://berkeley.qualtrics.com/jfe/form/SV_afxFnDutFrq5yLP)
