...
**POLL 1A**: How do I calculate the cosine of 2 pi?
...
**Question**: Are there other tricks that anyone knows of? Please post them on Piazza. 
...
We'll see a little bit of *base* graphics here and then *lattice* and *ggplot2* on Wednesday in Module 7.
...
In general, your answers to any questions should involve writing code to manipulate objects. For example, if I ask you to find the maximum value in a vector, do not scan through all the values and find it by eye. Use R to do the calculations and print results.
